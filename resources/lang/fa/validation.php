...
return [
    ...
    */
    'attributes' => [
        ...
        'price' =>  'قیمت',
        'capacity' =>  'ظرفیت',
        'duration_days' =>  'مدت زمان سفر',
        'start_date' =>  'تاریخ رفت',
        'end_date' =>  'تاریخ برگشت',
        'location' => "مکان",
        'price_per_person' => 'قیمت هر نفر',
        'currency' => 'واحد پول',
        'duration_nights' => 'تعداد شب‌های تور',
        'transportation_type' => 'نوع وسیله نقلیه',
        'food_count' => 'تعداد وعده‌های غذایی',
        'difficulty_level' => 'درجه سختی',
        'departure_location' => 'محل حرکت',
    ],
];
